...
To correct these failures, you must first set up the transformation scenario \(this only needs to be done once\).
...
* Go to the Crossref admin page: [**https://doi.crossref.org/servlet/useragent?func=showHome**](https://doi.crossref.org/servlet/useragent?func=showHome) ****and log in. 
...
* Click 'Apply associated \(1\)'.
  ...
  **Pro tip:** Next time, you should only have to press cmd + shift + t and it will do the work for you 🕺 
