...
* **No set article structure** - Feature articles do not have predefined structures or set level 1 headings. Further details on this can be found on the [**Article structure**](article-structure.md#feature-content) page.
