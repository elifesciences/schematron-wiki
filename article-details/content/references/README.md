...
Most eLife articles will include a reference list \(otherwise known as a bibliography\) containing details for all the previous works being cited in the text. These will usually consist mostly of journal articles and books but may also cover websites, papers presented at conferences, software, data, and other published material. The number of references cited will vary considerably between different article types. Insight articles will usually only have 10–15 references, while research content will likely have at least twice this. We have had articles with upwards of 150 references and some review articles, which survey the available literature on a subject, may reach as high as 200+ references.
