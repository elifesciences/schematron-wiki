...
Reference formatting is automatically derived from the tagging of the content; that is, the reference list itself does not capture formatting elements beyond italics and sub/superscript where it is present in the reference title. The italics for journal or books titles, the bolding for volume numbers, and so on is generated by the platform displaying the reference list. This means that reference display will be dependant on the version of the article being viewed.

![Reference on eLife website](../../../.gitbook/assets/screenshot-2021-10-05-at-12.19.07.png)

![Reference on PubMed Central](../../../.gitbook/assets/screenshot-2021-10-05-at-12.19.17.png)

![Reference on PubMed](../../../.gitbook/assets/screenshot-2021-10-05-at-12.20.35.png)
