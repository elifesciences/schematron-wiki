...
The eLife Editorial team will ideally update the impact statement before the the article is exported for processing, but sometimes this will be delayed until the decision letter/author response has been edited. In such cases, the exported impact statement will need to be replaced with the finalised Editors' Summary once this is available.
