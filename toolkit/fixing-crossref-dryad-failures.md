...
**Pro tip: **Next time, you only have to press cmd + shift + t and it will do the work for you :man_dancing: 
...
* You also need to update the timestamp and doi_batch_id elements within the XML for the same reason as above (duplicated file names). These can be found at the top of the file:

![Timestamp and doi_batch_id. ](../.gitbook/assets/screen-shot-2020-12-17-at-12.49.07.png)
...
![Updated timestamp and doi_batch_id.](../.gitbook/assets/screen-shot-2020-12-17-at-13.54.53.png)
